...
namespace glm
{
    ...
    {
        this->value[0] = _xvec3<T>(1, 0, 0, 0);
        this->value[1] = _xvec3<T>(0, 1, 0, 0);
        this->value[2] = _xvec3<T>(0, 0, 1, 0);
    }

    template <typename T> 
    inline _xmat3x4<T>::_xmat3x4(const T f)
    {
        this->value[0] = _xvec3<T>(f, 0, 0, 0);
        this->value[1] = _xvec3<T>(0, f, 0, 0);
        this->value[2] = _xvec3<T>(0, 0, f, 0);
    }
