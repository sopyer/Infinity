...
public:
	...
	void set()
	{
		...
		glLoadIdentity();
		//glLoadMatrixf(glm::lookAtGTX(position, look+position, up));
		SetPerspective();
	}
};
...
//	glm::mat3 matrix;
//public:
//	Camera():look(0,0,1), up(0,1,0), right(1,0,0), position(0,0,0)//, 
//		//matrix(glm::vec3(0,0,1), glm::vec3(0,1,0), glm::vec3(1,0,0))
//	{
//	} 
//	void move(glm::vec3 dir)
//	{
//		position = dir;
//		//matrix = glm::translate3DGTX(matrix, dir);
//	}
//	void rotate(float vert, float hor)
//	{
//		glm::mat3 t(right, up, look);
//		//this camera's for airplane where isn't plane on which moving
//		t *= glm::mat3GTX(glm::radians(glm::vec3(vert, 0, 0))) 
//			glm::mat3GTX(glm::radians(glm::vec3(0, hor, 0)));
//		//t*=glm::mat3GTX(glm::radians(glm::vec3(vert, hor, 0)));
//		right = glm::columnGTX(t,0);
//		up = glm::columnGTX(t,1);
//		look = glm::columnGTX(t,2);
//		//matrix = glm::rotate3DGTX(glm::rotate3DGTX(matrix, vert, glm::vec3(1, 0, 0)), hor, glm::vec3(0,1,0));
//		//matrix = glm::rotate3DGTX(glm::rotate3DGTX(matrix, hor, glm::vec3(0, 1, 0)), vert, glm::vec3(1,0,0));
//	}
//	void lookAt(glm::vec3 eye, glm::vec3 target, glm::vec3 upv)
//	{
//		position = eye;
//		look = target - eye;
//		up = upv;
...
//	{
//		glMatrixMode(GL_MODELVIEW);
//		//glLoadMatrixf(glm::inverseGTX(matrix));
//		//glm::vec3 look=glm::columnGTX(matrix, 2), up = glm::columnGTX(matrix, 1);
//		glLoadMatrixf(glm::lookAtGTX(position, look+position, up));
